...
<body>
  ...
  <div id="photo-gallery" class="photo-gallery" style="display: none;">
    <div class="gallery-container">
      <img src="foto 13.jpeg" class="gallery-photo">
    </div>
  </div>

  <script>
    const audio = new Audio('Seventeen-Fearless.mp3');
    ...
    const fullMessage = `Hidup bukan tentang seberapa sering kita jatuh 🌻, tetapi tentang bagaimana kita bangkit setiap kali menghadapi rintangan 🌈. Luka dan kegagalan bukan tanda kelemahan 🌼, melainkan bukti bahwa kita telah berani melangkah 🤍. Teruslah maju tanpa ragu 💪, sebab setiap langkah yang kita ambil, sekecil apa pun, membawa kita lebih dekat pada impian yang ingin dicapai ✨. Kepercayaan pada diri sendiri adalah kunci untuk menaklukkan jalan yang penuh tantangan 🌿, bukan untuk membuktikan sesuatu kepada orang lain, tetapi untuk menunjukkan bahwa kita mampu melewati segala hal dengan keteguhan hati 🌷. Tidak ada perjalanan yang selalu mulus 🚀, tetapi mereka yang tak menyerah akan melihat bagaimana setiap tantangan membentuk mereka menjadi pribadi yang lebih kuat 🤍.`;
